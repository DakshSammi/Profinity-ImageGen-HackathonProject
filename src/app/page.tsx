    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-10 px-0 pb-0 md:p-24 md:px-0 md:pb-0">
      <section className="flex w-full flex-col items-center justify-between gap-16 p-16 md:p-12 md:px-24">
        ...
        <header className="text-center">
          <h1 className="text-6xl font-bold md:text-7xl mb-2.5">
            Profinity <span className="text-primary">ImageGen</span>
          </h1>
          <p className="text-sm md:text-xl font-normal">
            Generate high quality images using AI with added profinity filter 🤖
          </p>
        </header>
        <ImageGenerator />
      </section>
